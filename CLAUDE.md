...
2. `AGENTS.md` — behavioral rules and operating instructions
3. `rules/repo_rules.md` — binding structural constraints
...
messages — there is no `specs/` directory. If any of the five files
