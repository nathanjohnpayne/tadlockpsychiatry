...
const D1: DirectionComponent = ({ tweaks, practice: P }) => {
  ...
  const sans = tweaks.sans || '"Inter", "Söhne", -apple-system, system-ui, sans-serif';
  ...
  return (
    <div ref={rootRef} className="d-root" style={styles.root}>
      ...
      <NavBarD1 fg={fg} dim={dim} faint={faint} accent={accent} mono={mono} />
      ...
      <PositioningD1 P={P} fg={fg} dim={dim} faint={faint} accent={accent} serif={serif} mono={mono} />

      <SpecialtiesD1 P={P} fg={fg} dim={dim} faint={faint} accent={accent} serif={serif} mono={mono} />

      <ProcessD1 P={P} fg={fg} dim={dim} faint={faint} veryFaint={veryFaint} accent={accent} serif={serif} mono={mono} />

      <AboutD1 P={P} fg={fg} dim={dim} faint={faint} accent={accent} serif={serif} mono={mono} />

      <WaitlistD1 P={P} fg={fg} dim={dim} faint={faint} bg={bg} accent={accent} serif={serif} mono={mono} />

      <FooterD1 P={P} fg={fg} dim={dim} faint={faint} accent={accent} serif={serif} mono={mono} />
    </div>
  );
};
...
const HeroD1Monogram = ({ P, fg, dim, faint, accent, serif, mono, scrollY, glyphRef }: any) => (
  <section style={{
    ...
    <div ref={glyphRef} style={{
      ...
      fontFamily: serif, fontSize: 720, fontWeight: 300,
    ...
    <div style={{ position: "relative", zIndex: 3, maxWidth: 1100 }}>
      ...
      <h1 style={{
        ...
        fontSize: "clamp(56px, 7.4vw, 124px)", lineHeight: 0.94,
...
const HeroD1Split = ({ P, fg, dim, faint, accent, serif, mono }: any) => (
  <section style={{
    ...
    <div>
      ...
      <h1 style={{
        fontFamily: serif, fontWeight: 300, fontSize: "clamp(48px, 5.6vw, 92px)",
...
const HeroD1Marquee = ({ P, fg, dim, faint, accent, serif, mono }: any) => (
  <section style={{ padding: "100px 0 80px", position: "relative", zIndex: 3, minHeight: "82vh" }}>
    ...
    <div style={{ padding: "80px 56px 0", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64 }}>
      <div>
...
const PositioningD1 = ({ P, fg, dim, faint, accent, serif, mono }: any) => (
  <section style={{ padding: "140px 56px 120px", borderTop: `0.5px solid ${faint}`, position: "relative", zIndex: 3 }}>
    <div style={{ display: "grid", gridTemplateColumns: "1fr 2.4fr", gap: 80, marginBottom: 80, alignItems: "start" }}>
      ...
      <h2 style={{
        fontFamily: serif, fontWeight: 300, fontSize: "clamp(40px, 4.4vw, 68px)",
    ...
    <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 56 }}>
      {P.positioning.map((c) => (
        <div key={c.k} style={{ borderTop: `1px solid ${faint}`, paddingTop: 24 }}>
          ...
          <h3 style={{ fontFamily: serif, fontWeight: 400, fontSize: 26, lineHeight: 1.15, letterSpacing: -0.5, margin: "0 0 16px" }}>{c.h}</h3>
    ...
    <section style={{ padding: "120px 56px 140px", borderTop: `0.5px solid ${faint}`, position: "relative", zIndex: 3 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 64 }}>
        <div>
          ...
          <h2 style={{ fontFamily: serif, fontWeight: 300, fontSize: "clamp(44px, 5vw, 76px)", lineHeight: 1, letterSpacing: -1.4, margin: 0 }}>
      ...
      <div>
        {P.specialties.map((s, i) => (
          <div key={s.n}
            ...
            style={{
              display: "grid", gridTemplateColumns: "70px 1fr 2.4fr 1fr",
            ...
            <h3 style={{
              ...
              fontSize: 30, lineHeight: 1.05, letterSpacing: -0.5, margin: 0,
    ...
    <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 32 }}>
      {P.process.map((p, i) => (
        <div key={p.n} style={{ position: "relative" }}>
          ...
          <h3 style={{ fontFamily: serif, fontWeight: 400, fontSize: 24, lineHeight: 1.15, margin: "0 0 14px", letterSpacing: -0.4 }}>{p.title}</h3>
...
const WaitlistD1 = ({ P, fg, dim, faint, bg, accent, serif, mono }: any) => {
  ...
  return (
    <section style={{ padding: "160px 56px", borderTop: `0.5px solid ${faint}`, position: "relative", zIndex: 3 }}>
      <div style={{ maxWidth: 980, margin: "0 auto", textAlign: "center" }}>
        ...
        <h2 style={{
          fontFamily: serif, fontWeight: 300,
          fontSize: "clamp(48px, 6vw, 96px)", lineHeight: 0.98, letterSpacing: -1.8, margin: 0, textWrap: "balance",
        }}>
...
const FooterD1 = ({ P, fg, dim, faint, accent, serif, mono }: any) => (
  <footer style={{ padding: "56px 56px 36px", borderTop: `0.5px solid ${faint}`, position: "relative", zIndex: 3 }}>
    <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 40, marginBottom: 64, alignItems: "start" }}>
      ...
      <FooterCol mono={mono} dim={dim} faint={faint} fg={fg} title="Office" items={[P.contact.address, P.contact.hours]} />
      <FooterCol mono={mono} dim={dim} faint={faint} fg={fg} title="Contact" items={[P.contact.email, "+1 415 · by request"]} />
      <FooterCol mono={mono} dim={dim} faint={faint} fg={fg} title="Notice" items={["No emergencies", "If in crisis, call 988"]} />
    </div>
    <div style={{
      borderTop: `0.5px solid ${faint}`, paddingTop: 24,
