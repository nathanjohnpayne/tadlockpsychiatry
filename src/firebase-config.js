...
// access controls are the Auth allowlist enforced in src/auth.js plus
// (future) Firestore/Storage rules and App Check. Server-side
// credentials (deploy auth) are 1Password-backed via op-firebase-deploy.
