...
Prevent `scripts/refresh-social-preview-images.mjs` from overwriting Mux-sourced GIFs.

**Scope (one PR):**
- Edit `scripts/refresh-social-preview-images.mjs`: skip any project whose frontmatter has `muxPlaybackId` set.
